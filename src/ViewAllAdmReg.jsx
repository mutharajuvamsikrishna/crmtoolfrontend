...
import { viewAllAdminReg } from './Services/Api';
import "./ViweAll.css";
import { MdEdit } from "react-icons/md";
import { MdDelete } from "react-icons/md";
import { useNavigate } from 'react-router-dom';
import { deleteAdminReg} from './Services/Api';
export default function ViewAllAdmReg() {
...
useEffect(() => {
  ...
  const handleSubmit2 = (email) => {
    ...
    navigate("/supadmeditbyadmin", { state: { data: data } });
  };
